...
class DivDropdownGenerator extends CommonClass {
    ...
    // generate dropdown
    public function generate( $listRows, $id, $partName, $part, $savedValue ){
        ...
        echo '>';
            ...
            // generate content
            $this->generateContent( $listRows, $id, $partName, $part, $savedValue );

            // generate input
            $this->generateInput( $listRows, $id, $partName, $savedValue );
    ...
    // generate content
    private function generateContent( $listRows, $id, $partName, $part, $savedValue ){
    ...
    // generate input
    private function generateInput( $listRows, $id, $partName, $savedValue ){

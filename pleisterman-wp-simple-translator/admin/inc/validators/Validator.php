...
namespace PleistermanWpSimpleTranslator\Admin\Validators;

use PleistermanWpSimpleTranslator\Common\Common;
use PleistermanWpSimpleTranslator\Admin\Base\CommonClass;
use PleistermanWpSimpleTranslator\Custom\Admin\Validators\CustomValidator;
...
class Validator extends CommonClass {
    ...
    public function __construct( Common $common ){
        ...
        $this->customValidator = new CustomValidator( $this->common ); 
    }
    // construct
        ...
        foreach( $part['validate'] as $validateOption ){
            ...
            if( !$returnValue['error'] ){
                ...
                if( isset( $this->validateFunctions[$validateOption] ) ){
                    ...
                    $this->customValidator->validate( $settingsId, $label, $partId, $part, $value, $values );
                    // debug
